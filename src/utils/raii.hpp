...
namespace vk
{
	namespace raii
	{
		namespace su
		{
			...
			{
				uint32_t memoryTypeIndex = vk::su::findMemoryType(memoryProperties, memoryRequirements.memoryTypeBits,
					memoryPropertyFlags);
			...
			void oneTimeSubmit(vk::raii::CommandBuffer const& commandBuffer, vk::raii::Queue const& queue,
				Func const& func)
			{
			...
			void setImageLayout(
				vk::raii::CommandBuffer const& commandBuffer, vk::Image image, vk::Format format,
				vk::ImageLayout oldImageLayout, vk::ImageLayout newImageLayout)
			{
				...
				case vk::ImageLayout::ePresentSrcKHR: destinationStage = vk::PipelineStageFlagBits::eBottomOfPipe;
					break;
				case vk::ImageLayout::eShaderReadOnlyOptimal: destinationStage =
			...
			struct BufferData
			{
					...
					size_t stride) const
				{
					...
					vk::raii::su::BufferData stagingBuffer(physicalDevice, device, dataSize,
			...
			struct SurfaceData
			{
					...
					: extent(extent_), window(vk::su::createWindow(windowName, extent))
				{
					...
					VkResult err = glfwCreateWindowSurface(static_cast<VkInstance>(*instance), window.handle, nullptr,
						&_surface);
					if (err != VK_SUCCESS)
			...
			struct SwapChainData
			{
				...
				{
					vk::SurfaceFormatKHR surfaceFormat = vk::su::pickSurfaceFormat(
					...
					{
						const uint32_t queueFamilyIndices[2] = { graphicsQueueFamilyIndex, presentQueueFamilyIndex };
				...
				vk::DescriptorSetLayoutCreateFlags flags = {})
			{
				...
				for (size_t i = 0; i < bindingData.size(); i++)
				{
					bindings[i] = vk::DescriptorSetLayoutBinding(
						vk::su::checked_cast<uint32_t>(i), std::get<0>(bindingData[i]), std::get<1>(bindingData[i]),
			...
			inline vk::raii::Instance makeInstance(vk::raii::Context const& context,
				...
				vk::Extent2D const& extent)
			{
				...
				vk::FramebufferCreateInfo framebufferCreateInfo(
					vk::FramebufferCreateFlags(), *renderPass, pDepthImageView ? 2 : 1, attachments, extent.width,
					extent.height, 1
				);
				...
				vk::raii::RenderPass const& renderPass)
			{
				std::array<vk::PipelineShaderStageCreateInfo, 2> pipelineShaderStageCreateInfos = {
					...
					vk::PipelineShaderStageCreateInfo({}, vk::ShaderStageFlagBits::eFragment, *fragmentShaderModule,
				...
				void const* pNext = nullptr)
			{
				...
				vk::DeviceCreateInfo deviceCreateInfo(vk::DeviceCreateFlags(), deviceQueueCreateInfo, {},
					enabledExtensions, physicalDeviceFeatures, pNext);
			...
			void updateDescriptorSets(
				...
				std::vector<std::tuple<vk::DescriptorType, vk::raii::Buffer const&, vk::DeviceSize, vk::raii::BufferView
				const*>> const& bufferData,
